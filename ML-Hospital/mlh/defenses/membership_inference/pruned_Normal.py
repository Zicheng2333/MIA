...
class TrainTargetNormal(Trainer):
    def __init__(self, model, model_name, device, num_class, epochs=100, learning_rate=0.01, momentum=0.9,
                 weight_decay=5e-4, smooth_eps=0.8, log_path="./"):
    ...
    def train(self, train_loader, test_loader):
        ...
        try:
            ...
            for e in range(1, self.epochs + 1):
                ...
                self.log_to_csv(e, len(train_loader.dataset), total_train_loss / len(train_loader.dataset), train_acc,
                                test_acc, time.time() - t_start)
